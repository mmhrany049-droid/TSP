      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            کتاب‌ها، ساختار و بانک تست فعال شد
          </CardTitle>
        </CardHeader>
        <CardBody className="space-y-3 text-sm text-slate-600">
          <p>
            در این مرحله می‌توانی کتاب کمک‌آموزشی بسازی، فصل و بخش‌هایش را به‌صورت درختی
            بچینی و تست‌ها را با شمارهٔ نمایشی، پاسخ صحیح و علامت‌های «مهم» و «سخت» در همان
            ساختار ثبت کنی.
          </p>
          <p>
            همهٔ داده‌ها به حساب خودت گره خورده است؛ احراز هویت با NextAuth و گذرواژه‌های
            هش‌شدهٔ bcrypt از مرحلهٔ پیش برقرار است. مرحلهٔ بعد، ثبت تلاش‌ها و مرور هوشمند
            است.
          </p>
        </CardBody>
      </Card>
